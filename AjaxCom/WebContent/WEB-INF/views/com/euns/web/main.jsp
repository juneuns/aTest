...
<script type="text/javascript" src="/euns/js/main.js"></script>
<style>
	h5, span {
		height: 20px;
		line-height: 30%;
...
<body>
	<form method="POST" action="/euns/member/${VIEW}" id="frm" name="frm">
			...
			<c:if test="${not empty SID}">
					...
					<div class="w3-col mt10">
						<div class="w3-col m3 pdh10">
							<h5 class="w3-col w3-button w3-pink w3-hover-light-green" id="listbtn">회원리스트</h5>
						</div>
						<div class="w3-col m3 pdh10">
